...
public class FacturaTemplate {
    public String buildInvoice(PaymentVoucher invoice) throws TemplateException {
        ...
        try {
            ...
            if (invoice.getTotalValorVentaExportacion() != null) {
                ...
                appendChild(doc, sacAdditionalMonetaryTotal, "cbc:PayableAmount",
                        UtilFormat.format(invoice.getTotalValorVentaExportacion())).
            ...
            if (StringUtils.isNotBlank(invoice.getFechaVencimiento())) {
                appendChild(doc, invoiceRootElement, "cbc:ExpiryDate", invoice.getFechaVencimiento());
            }
