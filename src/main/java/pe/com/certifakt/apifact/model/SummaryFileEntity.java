...
@NoArgsConstructor
@Builder
public class SummaryFileEntity implements Serializable {

    private static final long serialVersionUID = 1L;

    @Id
    @SequenceGenerator(name = "file_summary_pago_seq", sequenceName = "file_summary_pago_seq", allocationSize=1)
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "file_summary_pago_seq")
    private Long id;
    ...
    @ManyToOne
    @JoinColumn(name = "id_document_summary")
    ...
    public boolean equals(Object o) {
        ...
        SummaryFileEntity that = (SummaryFileEntity) o;
